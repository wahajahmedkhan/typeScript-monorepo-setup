...
# Typescript Mono-repo Setup

Start by installing Nx as it will handle Mono-repos like a pro as it uses Google&#39;s best practices.
...
Libraries are shareable across libraries and applications. They can be imported from `@type-script-monorepo-setup/mylib`.
